      ...
      <header className="border-b border-border/60 py-6 px-8">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <img src={logoAcervo} alt="Acervo 10.55" className="h-12" />
          </Link>
      ...
      <main className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="space-y-10 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p>
              A plataforma <strong className="text-foreground">Acervo 10.55</strong> é um catálogo digital exclusivo para arquitetos e profissionais de design de interiores. 
          ...
          <section>
            ...
            <p>
              ...
              entre em contato pelo e-mail: <strong className="text-foreground">privacidade@acervo1055.com.br</strong>
            </p>
          </section>
        </div>
      </main>
      ...
      <footer className="py-12 border-t border-border/50 bg-background">
        <div className="max-w-4xl mx-auto px-8 text-center">
          <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground/50">
            © {new Date().getFullYear()} Acervo 10.55 — Todos os direitos reservados
          </p>
        </div>
      </footer>
    </div>
