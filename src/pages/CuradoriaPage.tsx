...
export default function CuradoriaPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>Curadoria Acervo | Acervo 10.55</title>
        <meta name="description" content="Seleções de produtos criadas pelo Acervo 10.55 para projetos de arquitetura e interiores." />
      </Helmet>
      ...
      <section className="relative min-h-[72vh] overflow-hidden bg-black text-white">
        ...
        <div className="relative mx-auto flex min-h-[72vh] max-w-7xl flex-col justify-end px-6 pb-14 pt-28 md:px-10 lg:px-12">
          <span className="mb-5 text-[10px] uppercase tracking-[0.32em] text-white/70">Curadoria Acervo</span>
                ...
                <div className="mx-auto grid max-w-7xl gap-8 px-6 py-12 md:px-10 lg:grid-cols-[0.95fr_1.25fr] lg:px-12 lg:py-16">
                  ...
                  <div className="flex flex-col justify-between">
                    <div className="max-w-2xl">
                      <span className="text-[10px] uppercase tracking-[0.25em] text-accent">Curadoria Acervo</span>
                        ...
                        >
                          ...
                          <div className="min-w-0 self-center">
                            ...
                            <p className="mt-1 truncate text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
                              {brandMap.get(product.brand_id) || 'Acervo'}
                            </p>
