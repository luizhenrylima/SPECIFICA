...
import logoAcervoWhite from '@/assets/logo-acervo-white.png';
...
export default function ProjectsPage() {
  ...
  const generateMoodboard = async () => {
    ...
    try {
      ...
      const logoData = await loadImage(logoAcervo, 'PNG');
      const logoWhiteData = await loadImage(logoAcervoWhite, 'PNG');
      ...
      const drawFooter = () => {
        ...
        doc.setFontSize(5.5);
        doc.setTextColor(...warmGray);
        doc.text('Acervo 10.55  |  contato@acervo1055.com.br  |  www.acervo1055.com.br', 15, footerY);
      };
      ...
      doc.setFontSize(6);
      doc.setTextColor(210, 204, 194);
      doc.text('Acervo 10.55', leftPad, pageH - 15);
