...
import logoAcervo from '@/assets/logo-acervo.png';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      <Helmet>
        <title>Acervo 10.55 — Mobiliário Brasileiro Contemporâneo</title>
        <meta name="description" content="Curadoria de mobiliário de luxo para arquitetos e designers. Marcas exclusivas, acabamentos e blocos 3D em um só lugar." />
        <link rel="canonical" href="https://acervo1055.com.br/" />
        <meta property="og:title" content="Acervo 10.55 — Mobiliário Brasileiro Contemporâneo" />
        <meta property="og:description" content="Curadoria de mobiliário de luxo para arquitetos e designers." />
        <meta property="og:url" content="https://acervo1055.com.br/" />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <div>
              ...
              <div className="space-y-5 text-sm text-muted-foreground font-light leading-relaxed">
                <p>
                  A Acervo 10.55 nasceu para ser a extensão do escritório do arquiteto.
      ...
      <footer className="py-16 border-t border-border/50 bg-background">
        <div className="max-w-7xl mx-auto px-8 flex flex-col items-center gap-6">
          <img src={logoAcervo} alt="Acervo 10.55" className="h-12 opacity-80" />
