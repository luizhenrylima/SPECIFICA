...
/* ============================================================
   /marketing — Tema claro · Logo Acervo · Eventos persistidos
...
const FIXED_MARKERS: Marker[] = [
  { date: launchISO, title: "Lançamento Plataforma Acervo", type: "lancamento", emoji: "🚀" },
...
function MarketingContent() {
  ...
  async function exportPDF(from?: string, to?: string, perSlide: 2 | 4 = 2) {
    ...
    for (let s = 0; s < totalSlides; s++) {
      ...
      doc.setTextColor(...muted);
      doc.setFontSize(8);
      doc.text(T("Acervo 10.55 - Marketing"), M, pageH - 14);
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#faf7f2] via-[#f5efe6] to-[#ede4d3] text-[#2a2520]">
      ...
      <header className="border-b border-[#d9cdb6]/60 backdrop-blur-md sticky top-0 z-30 bg-[#faf7f2]/85">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 sm:gap-4">
            <img src={logoAcervo} alt="Acervo" className="h-10 sm:h-12 w-auto object-contain" style={{ filter: "brightness(0.15)" }} />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
                ...
                {selected === launchISO && (
                  <div className="rounded-lg border border-[#b89968] p-4 bg-[#f5efe6]">
                    ...
                    <div className="text-sm">Plataforma Acervo vai ao ar hoje.</div>
                  </div>
                )}
              </div>
        ...
        <footer className="text-center text-[#8a7350] text-xs pt-6 border-t border-[#d9cdb6]">
          Acervo 10.55 · Cronograma de Marketing 2026 · Uso interno
        </footer>
      </main>
...
export default function MarketingPage() {
  ...
  useEffect(() => {
    document.title = "Marketing ? Acervo 10.55";
  }, []);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#faf7f2] px-4">
        <div className="text-center">
          <img src={logoAcervo} alt="Acervo 10.55" className="h-20 w-auto mx-auto mb-6 object-contain" style={{ filter: "brightness(0.15)" }} />
