...
export default function AdminPage() {
  ...
  const handleSaveCuratedCollection = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Seleção salva na Curadoria Acervo.');
    } catch (error: any) {
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <section>
          ...
          <div className="bg-card p-6 md:p-8 rounded-2xl border border-border mt-8">
            <div className="mb-6 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
              <div>
                <span className="text-[10px] uppercase tracking-[0.22em] text-accent">Curadoria Acervo</span>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-serif text-foreground">Página Acervo</h2>
          </div>
